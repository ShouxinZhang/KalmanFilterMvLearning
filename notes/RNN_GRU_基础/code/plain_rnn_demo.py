...
"""Minimal plain-RNN sentiment demo for the note.
...
class PlainRNNClassifier(nn.Module):
    """A minimal plain-RNN classifier for short sentiment sequences."""
...
def main() -> None:
    ...
    model = PlainRNNClassifier(
        vocab_size=len(vocab),
        embed_dim=EMBED_DIM,
        hidden_dim=HIDDEN_DIM,
    ).to(device)

    print("Training plain RNN on the easy toy sentiment dataset")
